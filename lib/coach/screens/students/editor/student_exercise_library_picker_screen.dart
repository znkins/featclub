...
class StudentExerciseLibraryPickerScreen extends ConsumerStatefulWidget {
  ...
  ConsumerState<StudentExerciseLibraryPickerScreen> createState() =>
      _StudentExerciseLibraryPickerScreenState();
}

class _StudentExerciseLibraryPickerScreenState
    extends ConsumerState<StudentExerciseLibraryPickerScreen> {
  ...
  Future<void> _add() async {
    ...
    try {
      ...
      for (final id in _selected) {
        await service.createExerciseFromLibrary(
