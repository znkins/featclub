...
/// Historique complet des séances terminées par un élève (lecture seule).
class StudentHistoryListScreen extends ConsumerWidget {
  const StudentHistoryListScreen({super.key, required this.studentId});
